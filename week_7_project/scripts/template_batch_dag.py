...
job = DataflowTemplateOperator(
        ...
        template="ggs://gcs-bucket-yelp/batchtemplate",
        job_name='job_test_from_airflow',
        
        dataflow_default_options={
            "project": "yelp-zoomcamp-de",
            "stagingLocation": "gs://gcs-bucket-yelp/dataflow/staging",
            "tempLocation": "gs://gcs-bucket-yelp/dataflow/temp",
            "serviceAccountEmail": "svc-rw@fabric-1333.iam.gserviceaccount.com"},
        parameters={
            "input_path": "gs://gcs-bucket-yelp/data3/*",
            "table": "test.business",
